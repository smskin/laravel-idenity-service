 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @return \SMSkin\IdentityServiceClient\Guard\HasIdentity|null 
         * @throws Exception
         * @static 
         */ 
        public static function user()
        {
                        /** @var \SMSkin\IdentityServiceClient\Guard\SessionGuard $instance */
         ...
         *
         * @param int $minutes
         * @return \SMSkin\IdentityServiceClient\Guard\SessionGuard 
         * @static 
         */ 
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        \SMSkin\IdentityServiceClient\Guard\SessionGuard::macro($name, $macro);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        \SMSkin\IdentityServiceClient\Guard\SessionGuard::mixin($mixin, $replace);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        return \SMSkin\IdentityServiceClient\Guard\SessionGuard::hasMacro($name);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Auth\SessionGuard         
                        \SMSkin\IdentityServiceClient\Guard\SessionGuard::flushMacros();
        }
